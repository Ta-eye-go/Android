...
class BookmarkAdd : AppCompatActivity(), TextToSpeech.OnInitListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        chat_menu.menu_text.text = "즐겨찾기 신규추가"
                ...
                if (resultCode == Activity.RESULT_OK && data != null) {
                    ...
                    result?.let {
                        ...
                        if (recognizedText.isNotEmpty()) { // 데이터를 입력했으면
                            ...
                            Toast.makeText(this@BookmarkAdd, "다시 말씀해주세요!", Toast.LENGTH_SHORT).show()
                        }
                    }
                }
            }
